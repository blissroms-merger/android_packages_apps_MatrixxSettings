...
public class DataIcons extends SettingsPreferenceFragment {
    ...
    public class Adapter extends RecyclerView.Adapter<Adapter.CustomViewHolder> {
        ...
        public void onBindViewHolder(CustomViewHolder holder, final int position) {
            ...
            holder.image1.setBackgroundDrawable(getDrawable(holder.image1.getContext(), iconPkg, "ic_4g_mobiledata"));
            holder.image2.setBackgroundDrawable(getDrawable(holder.image2.getContext(), iconPkg, "ic_4g_plus_mobiledata"));
            holder.image3.setBackgroundDrawable(getDrawable(holder.image3.getContext(), iconPkg, "ic_5g_mobiledata"));
            holder.image4.setBackgroundDrawable(getDrawable(holder.image4.getContext(), iconPkg, "ic_lte_mobiledata"));
            ...
            holder.name.setText("com.android.systemui".equals(iconPkg) ? "Default" : getLabel(holder.name.getContext(), iconPkg));
